...
return [
    ...
    'system_prompt' => env('KAI_SYSTEM_PROMPT') ?: 'You are KAI, a concise ERP assistant. Answer only from the provided permission-safe context.',
    ...
    'context_limits' => [
        ...
        'attendance_session_items' => (int) env('KAI_CONTEXT_ATTENDANCE_SESSION_ITEMS', 5),
        'assignment_items' => (int) env('KAI_CONTEXT_ASSIGNMENT_ITEMS', 5),
        'assessment_component_items' => (int) env('KAI_CONTEXT_ASSESSMENT_COMPONENT_ITEMS', 5),
        'class_items' => (int) env('KAI_CONTEXT_CLASS_ITEMS', 5),
