...
class HostelRoomResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Hostel Rooms';

    protected static ?string $modelLabel = 'Hostel Room';

    protected static ?string $pluralModelLabel = 'Hostel Rooms';
